...
//initialise problem struct with global variables v and p.
...
int main()
{
    ...
    print_sol(local_optimum_sln, "First Decent Local Optima Solution");


    NB_METHOD=1;
    struct solution *local_optimum_sln2;
    local_optimum_sln2 = local_search(init_sln, NB_METHOD); //local search
    print_sol(local_optimum_sln2, "Best Decent Local Optima Solution");
