...
class FitnessCache:
    ...
    def get_fitness(self, chromosome):
        """retrieve fitness"""
        # TODO: what is the fitness criteria / how is it calcualted?
...
def crossover(parent1, parent2, crossover_rate=0.85):
    """OX"""
    # TODO: what is being crossed over? what is swaped, or changed?
...
def optimized_genetic_packing(
    ...
    """Genetic Algorithm"""
    # TODO: what does the FitnessCache do? What does it store?
    cache = FitnessCache(items, capacity)
    # TODO: what is a population? Is it an array of items?
    ...
    for gen in range(generations):
        ...
        # get fitnesses # TODO: what does the fitnesses array contains, what does each element in it means?
        fitnesses = [cache.get_fitness(ind) for ind in population]
        
        # Select elite individuals # TODO: select base on what?
        elites = sorted(
            zip(population, fitnesses),
            key=lambda x: x[1],
            reverse=True
        )[:elite_size]
        # TODO: what does the elites array contain, how is it created?
        elites = [ind.copy() for ind, _ in elites]
        
        # TODO: how is the best_fitness determined?
        ...
        while len(new_population) < pop_size:
            # TODO: how are these parents selected, what's the criteria/standard?
...
if __name__ =="__main__":
    ...
    for ins in instances:
        ...
        # find the best solution that uses minimum number of bins
